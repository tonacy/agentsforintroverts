const proofPoints = [
  ...
  },
  {
    ...
    description:
      "Running builder gatherings in Austin — using agents to handle the logistics so I can actually enjoy them.",
  },
];
        ...
        <div className="grid gap-12 sm:grid-cols-3 sm:gap-8">
          {proofPoints.map((point, index) => (
            <article key={point.title} className="relative group">
              {/* Decorative number */}
              <span className="font-display text-6xl font-light text-terracotta-soft absolute -top-4 -left-2 select-none opacity-80">
