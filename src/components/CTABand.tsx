...
export function CTABand() {
  return (
    <section className="relative bg-leaf-deep px-6 py-24 sm:py-32 overflow-hidden">
      {/* Subtle texture */}
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        <h2 className="font-display text-4xl font-light tracking-tight text-paper sm:text-5xl">
          Ready to protect your focus<br className="hidden sm:block" /> and still show up?
        </h2>
        <p className="mt-6 text-lg text-paper/70">
          Get the free playbook:{" "}
          <span className="text-brass-glow">The Quiet Operator&apos;s Agent Stack</span>
        </p>
